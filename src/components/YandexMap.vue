...
import { MKAD_COORDS, MAP_CENTER, MAP_ZOOM, POLYGON_STYLE } from '@/constants/map'
...
const initMap = () => {
    ymaps.ready(() => {
        try {
            ...
            const mkadPolygon = new ymaps.Polygon(MKAD_COORDS, {
...
const findRoadIntersection = (route) => {
    ...
    const debugCollection = new maps.GeoObjectCollection()
